...
const VerifyOTP = () => {
  ...
  const { user, isEmailVerified, verifyOtp, resendOtp } = useAuth();
  ...
  }, [isEmailVerified, user, redirect, navigate]);
  ...
  const handleVerify = async (code?: string) => {
    ...
    try {
      ...
      if (error) {
        ...
        } else if (error.message?.includes('inválido') || error.message?.includes('invalid') || error.message?.includes('Invalid')) {
